...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platform performance including total Vehicle, bookings, revenue, and recent activities "/>
      ...
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
        {dashboardCards.map((card, index) => (
          <div key={index} className='flex gap-2 items-center justify-between p-4 rounded-md border border-borderColor'>
            ...
            <div className='flex items-center justify-center w-10 h-10 rounded-full bg-beige/10'>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
          ...
          {data.recentBookings.map((booking, index )=>(
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                <div className='hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-beige/10'>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md md:max-w-xs w-full'>
          ...
          <p className='text-3xl mt-6 font-semibold text-beige'>{currency}{data.monthlyRevenue}</p>
        </div>
