...
const CarCard = ({car}) => {
  ...
  return (
    <div onClick={() => { navigate(`/car/${car._id}`); scrollTo(0,0) }} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
